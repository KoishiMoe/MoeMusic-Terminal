...
MoeMusic Terminal 是一个面向 MoeMusic 运行时的轻量级独立单用户终端客户端。
...
<!-- Windows Terminal 运行截图占位符 -->
<!-- ![Windows Terminal 运行截图](/path/to/windows_terminal_screenshot.png) -->

<!-- Linux Kitty 运行截图占位符 -->
<!-- ![Linux Kitty 运行截图](/path/to/kitty_screenshot.png) -->

<!-- Linux Konsole 运行截图占位符 -->
<!-- ![Linux Konsole 运行截图](/path/to/konsole_screenshot.png) -->
